...
# My widgets
from UI.form_for_admin.ui_quest_form.Ui_QuestManyAnswers import Ui_QuestManyAnswers
...
class QuestManyAnswers(QWidget, Ui_QuestManyAnswers):
    ...
    def __check_answer(self):
        ...
        if self.answer1_check_box.isChecked():
            answer.append(self.answer1_text_edit.toPlainText())

        if self.answer2_check_box.isChecked():
            answer.append(self.answer2_text_edit.toPlainText())

        if self.answer3_check_box.isChecked():
            answer.append(self.answer3_text_edit.toPlainText())

        if self.answer4_check_box.isChecked():
            answer.append(self.answer4_text_edit.toPlainText())
