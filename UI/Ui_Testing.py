...
class Ui_Testing(object):
    def setupUi(self, Testing):
        ...
        self.hint_timer_label = QtWidgets.QLabel(self)
        self.hint_timer_label.setMinimumSize(QtCore.QSize(70, 0))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.hint_timer_label.setFont(font)
        self.hint_timer_label.setObjectName("hint_timer_label")
        self.horizontal_layout_bottom.addWidget(self.hint_timer_label)

        self.timer_label = QtWidgets.QLCDNumber()  # was QtWidgets.QLabel(Testing)
    ...
    def retranslateUi(self, Testing):
        ...
        self.hint_timer_label.setText(_translate("Testing", "До конца: "))
